...
using Moq;
using Xunit;
using KesifUygulamasi.ViewModels;
using KesifUygulamasi.Services.Interfaces;
...
namespace KesifUygulamasi.Tests.ViewModels
{
    ...
    public class RouteViewModelTests
    {
        ...
        {
            // Arrange
            var startLocation = new Location(39.9, 32.8);
            var endLocation = new Location(41.0, 29.0);
            var expectedRoute = new List<Location>
            {
                startLocation,
                new Location(40.0, 31.0),
                new Location(40.5, 30.0),
                endLocation
            };

            _mockRouteService
                .Setup(x => x.GetRouteAsync(It.IsAny<Location>(), It.IsAny<Location>()))
            ...
            // Act
            await _viewModel.GenerateRouteCommand.Execute(null);
        ...
        [Fact]
        public async Task GenerateRouteCommand_WithNullStartLocation_ShouldSetErrorMessage()
        {
            // Arrange
            _viewModel.StartLocation = null;
            _viewModel.EndLocation = new Location(41.0, 29.0);
            ...
            _mockRouteService.Verify(x => x.GetRouteAsync(It.IsAny<Location>(), It.IsAny<Location>()), Times.Never);
        }

        [Fact]
        public async Task GenerateRouteCommand_WithNullEndLocation_ShouldSetErrorMessage()
        {
            // Arrange
            _viewModel.StartLocation = new Location(39.9, 32.8);
        ...
        [Fact]
        public async Task GenerateRouteCommand_WhenServiceThrowsException_ShouldSetErrorMessage()
        {
            // Arrange
            var startLocation = new Location(39.9, 32.8);
            var endLocation = new Location(41.0, 29.0);
        ...
        [Fact]
        public async Task GenerateRouteCommand_ShouldSetIsBusyDuringExecution()
        {
            // Arrange
            var startLocation = new Location(39.9, 32.8);
            var endLocation = new Location(41.0, 29.0);
            ...
            // Act
            var executeTask = _viewModel.GenerateRouteCommand.Execute(null);
            
            // Complete the mock service call
            tcs.SetResult(new List<Location> { startLocation, endLocation });
            await executeTask;
        ...
        [Fact]
        public async Task GenerateRouteCommand_WhenAlreadyBusy_ShouldNotExecute()
        {
            // Arrange
            var startLocation = new Location(39.9, 32.8);
            var endLocation = new Location(41.0, 29.0);
        ...
        [Fact]
        public async Task GenerateRouteCommand_ShouldClearPreviousRoutePoints()
        {
            // Arrange
            var startLocation = new Location(39.9, 32.8);
            var endLocation = new Location(41.0, 29.0);
            var newRoute = new List<Location> { startLocation, endLocation };

            // Add some initial points
            _viewModel.RoutePoints.Add(new Location(1.0, 1.0));
            _viewModel.RoutePoints.Add(new Location(2.0, 2.0));
        ...
        {
            // Arrange
            var location = new Location(41.0, 29.0);
            var propertyChangedRaised = false;
